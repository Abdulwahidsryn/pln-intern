        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link
                            :href="Auth::guard('admin')->check() ? route('admin.profile.edit') : route('profile.edit')">
                            {{ __('Profile') }}
                        </x-dropdown-link>
                        ...
                        <form method="POST"
                            ...
                            @csrf
                            <x-dropdown-link
                                :href="Auth::guard('admin')->check() ? route('admin.logout') : route('logout')" onclick="event.preventDefault();
